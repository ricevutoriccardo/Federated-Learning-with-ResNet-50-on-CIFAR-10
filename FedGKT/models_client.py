...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d #batch_norm2d
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False, groups=1,
        ...
        self.inplanes = 16  # 64 instead of 16 in order to match our model
        self.dilation = 1
        ...
        self.layer1 = self._make_layer(block, 16, layers[0])  # 64 instead of 16 in order to match our model
...
def ResNet8(c=10, n_type="batch_norm", **kwargs):
    global norm_type
    norm_type = n_type
